# -*- coding: utf-8 -*-
__filename = '/datos/workspaces/01_github/openttd/inspiration-reference/firs-3.0.9-source/bundle_dir/src/src/templates/parameters.pynml'
...
def initialize(__loader, macros, nothing, template):
    ...
    def render(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            # <Static value=<ast.Dict object at 0x7f15dd636250> name=None at 7f15dd636820> -> __attrs_139731882857904
            __attrs_139731882857904 = _static_139731885318736
            __backup_economy_139731896297168 = get('economy', __marker)

            # <Value 'economies' (21:35)> -> __iterator
            __token = 1252
            __iterator = getitem('economies')
            (__iterator, ____index_139731882860448, ) = getitem('repeat')('economy', __iterator)
            econtext['economy'] = None
            for __item in __iterator:
                econtext['economy'] = __item

                # <Interpolation value=<Substitution '\n    if (economy_selection == ${repeat.economy.index}) {\n        economy = ${economy.numeric_id};\n    }\n' (21:46)> braces_required=True translation=False default='"?"' default_marker='"?"' at 7f15dd3dd3d0> -> __content_139731891488880
                __token = 1268
                __token = 1295
                ...
                __token = 1340
                __content_139731891488880_1338 = _lookup_attr(getitem('economy'), 'numeric_id')
                __content_139731891488880_1338 = __quote(__content_139731891488880_1338, '\x00', '&#0;', None, None)
                __content_139731891488880 = ('%s%s%s%s%s' % ('\n    if (economy_selection == ', (__content_139731891488880 if (__content_139731891488880 is not None) else ''), ') {\n        economy = ', (__content_139731891488880_1338 if (__content_139731891488880_1338 is not None) else ''), ';\n    }\n', ))
                ...
                ____index_139731882860448 -= 1
                if (____index_139731882860448 > 0):
                    __append('')
            if (__backup_economy_139731896297168 is __marker):
                del econtext['economy']
            else:
                econtext['economy'] = __backup_economy_139731896297168
